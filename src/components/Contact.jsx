...
const Contact = () => {
  ...
  const serviceKey = import.meta.env.VITE_APP_EMAILJS_SERVICE_ID;
  const templateKey = import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID;
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: 'Momentum Masters',
          from_email: form.email,
          to_email: 'kanwarnaonihalgill@gmail.com',
